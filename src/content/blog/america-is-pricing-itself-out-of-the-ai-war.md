---
draft: false
title: "America Is Pricing Itself Out of the AI War"
snippet: "America cannot lead the AI era by restricting open weights and pricing capable intelligence beyond the reach of defenders, small businesses, and ordinary citizens."
image:
  src: "/assets/blog/america-is-pricing-itself-out-of-the-ai-war.webp"
  alt: "A contemporary civic assembly raising their hands in a shared oath beneath a glowing open network"
  caption: "A contemporary editorial reimagining of Jacques-Louis David’s The Tennis Court Oath (1791). The original commemorates the National Assembly’s vow not to disband until a constitution was established; its converging crowd represents popular sovereignty, unity, and collective resolve—here applied to broad access to AI."
  source:
    label: "Reference artwork via TheCollector"
    url: "https://cdn.thecollector.com/wp-content/uploads/2021/09/david-tennis-court-oath.jpg?width=1400&quality=55"
publishDate: "2026-07-20 09:00"
author: "Tobalo Torres-Valderas"
category: "AI Policy"
tags: [ai_policy, open_weights, cybersecurity, economic_access, national_security]
---
...
The machinery for a de facto ban is being tested. ([Reuters][1])
...
In [The Art of War in the Information Age](https://y2.dev/blog/research/the-art-of-war-in-the-information-age), I wrote about US and Chinese competition as a grand chessboard of currency, information, cyber operations, supply chains, and industrial power.
...
GPT-5.6 Sol is priced at $30 per million output tokens. Claude Fable 5 and Mythos 5 are priced at $50 per million output tokens. That is before input tokens, long-context premiums, retries, tool calls, agent loops, infrastructure, and engineering. ([OpenAI Developers][3])
...
Freddie Mac estimated the US housing shortage at 3.7 million units using data through the third quarter of 2024. USDA now projects higher cattle prices in 2026 as tight supplies persist. The mechanics differ, but the incentive pattern is familiar: tolerate scarcity, protect incumbency, subsidize demand, normalize higher prices, and avoid structural reform. ([Freddie Mac][4])
...
1. [The Art of War in the Information Age, Y2](https://y2.dev/blog/research/the-art-of-war-in-the-information-age)
2. [The secret Trump administration battle to fight Chinese AI, Axios](https://www.axios.com/2026/07/20/ai-us-china-open-source-kimi)
3. [Anthropic disables top-tier models after US access order, Reuters](https://www.reuters.com/technology/us-blocks-foreign-access-anthropics-most-advanced-ai-models-axios-reports-2026-06-13/)
4. [US removes curbs on Anthropic’s Fable and Mythos models, Reuters](https://www.reuters.com/business/us-lift-export-controls-anthropics-fable-ai-model-tuesday-source-says-2026-06-30/)
5. [Dual-Use Foundation Models with Widely Available Model Weights, NTIA](https://www.ntia.gov/programs-and-initiatives/artificial-intelligence/open-model-weights-report)
